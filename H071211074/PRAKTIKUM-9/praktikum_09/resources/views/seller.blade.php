      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            ...
            <a href="/seller/edit/{{$row->id}}"><button type="button" class="btn" style="color : white; background : black; margin-bottom:5px ">Edit</button></a>
            <a href="/seller/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background : black; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
        @endforeach
      </tbody>
