    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            <a href="/permission/edit/{{$row->id}}"><button type="button" class="btn" style="color : white; background : black; margin-bottom:5px ">Edit</button></a>
            <a href="/permission/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background : black; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
        @endforeach
      </tbody>
