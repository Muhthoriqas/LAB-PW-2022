      ...
      <tbody>
        ...
        <tr>
          ...
          <td scope="row">
            ...
            <a href="/product/edit/{{$row->id}}"><button type="button" class="btn" style="color : white; background : black; margin-bottom:5px ">Edit</button></a>
            <a href="/product/delete/{{$row->id}}"><button type="button" class="btn" style="color : white; background : black; margin-bottom:5px">Delete</button></a>
          </td>
        </tr>
        @endforeach
      </tbody>
