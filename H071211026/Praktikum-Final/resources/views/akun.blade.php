...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h1 class="h2 mt-3">Data Dosen</h1>

        <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahdosen">Tambah +</a>
            ...
            <div class="col-sm-auto">
              <div class="card" style="width: 15rem;">
                <div class="card-body">
                  ...
                  <a href="/dosen/{{ $item->id }}" class="btn btn-primary">Details</a>
                </div>
              </div>
            </div>
            @endforeach
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="items items-courses items-sessions">
                  ...
                  <div class="p-3 border bg-opacity-20 rounded">
                    ...
                    <p class="block-info">{{ $item->username }}</p>
                    <a href="/dosen/{{ $item->id }}" class="btn btn-secondary">Details</a>
                  </div>
                </div>
              </div>
              @endforeach
        ...
        <h1 class="h2 mt-3">Data Mahasiswa</h1>

        <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahmhs">Tambah +</a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="items items-courses items-sessions">
                  ...
                  <div class="p-3 border bg-opacity-20 rounded">
                    <h5 class="title">{{ $item->nama }}</h5>
                    <p class="block-info">{{ $item->username }}</p>
                    <a href="/mhs/{{ $item->id }}" class="btn btn-secondary">Details</a>
                  </div>
                </div>
              </div>
              @endforeach
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Buat Akun Dosen</h1>
        ...
        <div class="modal-body">
            <form action="/tambahdosen" method="post">  
                ...
                <div class="form-floating mb-4">
                  <input name="username" type="text" id="form3Example3" class="form-control @error('username') is-invalid @enderror" value="{{old('username')}}"/>
                ...
                <div class="form-floating mb-4">
                  <input name="password" type="text" id="form3Example3" class="form-control @error('password') is-invalid @enderror" value="{{old('password')}}"/>
  ...
  <div class="modal fade" id="tambahmhs" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Buat Akun Mahasiswa</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="/tambahmhs" method="post">  
                @csrf
                <div class="form-floating mb-4">
                  <input name="nama" type="text" id="form3Example3" class="form-control @error('nama') is-invalid @enderror" value="{{old('nama')}}"/>
                  <label class="form-label" for="form3Example3">Nama </label>
