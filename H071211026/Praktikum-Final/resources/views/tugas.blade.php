...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div
          ...
          <h1 class="h2">{{ $kelas->nama }}</h1>
          <div class="btn-toolbar mb-2 mb-md-0">
          </div>
        </div>

        @can('dosen')
        <a type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahtugas">Tambah +</a>
        @endcan
                  ...
                  <div class="items items-courses items-sessions">
                    ...
                    <div class="p-3 border bg-opacity-20 rounded">
                      <h5 class="title">{{ $item->nama }}</h5>
                        @can('mhs')
                        <form action="/uptugas/{{ $item->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        @endcan
                      {{-- <a href="/matakuliah/{{ $item->id }}" class="btn btn-secondary">Lihat Tugas</a> --}}
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/tambahtugas" method="post">  
                        @csrf
