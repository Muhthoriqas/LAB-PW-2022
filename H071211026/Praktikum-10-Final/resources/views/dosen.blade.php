...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="items items-courses items-sessions">
                  ...
                  <div class="p-3 border bg-opacity-20 rounded">
                    ...
                    <p class="block-info">NIP: {{ $details->username }}</p>
                    <a type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editDosen">Edit</a>
                    <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteDosen">Delete</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="/updatedosen/{{ $details->id }}" method="post">
                    @csrf
                    ...
                    <div class="form-floating mb-4">
                      <input name="username" type="text" id="form3Example3" class="form-control @error('username') is-invalid @enderror" value="{{ $details->username }}"/>
        ...
        <div class="modal fade" id="deleteDosen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Akun Dosen</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form action="/deletedosen/{{ $details->id }}" method="get">
                    @csrf
