...
<body>
    ...
    <div class="mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/permission/tambah" method="POST">
                    @csrf
                    <div class="mb-3 row">
                ...
                <table class="table">
                    ...
                    @foreach($data as $item)
                        <tr>
                            ...
                            <td scope="row">
                                <a href="/permission/edit/{{$item->id}}"><button type="button" class="btn btn-warning">Edit</button></a>
                                <a href="/permission/delete/{{$item->id}}"><button type="button" class="btn btn-warning">Edit</button></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
