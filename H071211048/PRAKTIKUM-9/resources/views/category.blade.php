                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td scope="row">
                                <a href="/category/edit/{{$item->id}}"><button type="button" class="btn btn-warning">Edit</button></a>
                                <a href="/category/delete/{{$item->id}}"><button type="button" class="btn btn-warning">Edit</button></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
