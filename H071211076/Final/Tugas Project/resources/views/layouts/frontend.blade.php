  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> omagaorganic.com</li>
          <li>Enjoy your Organic Meal</li>
        </ul>
      </div>
    </div>
    <!-- Humberger End -->
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: St Omaga</li>
                <li>Phone: +62 811 233</li>
                <li>Email:omagaorganic.com</li>
              </ul>
            </div>
          </div>
