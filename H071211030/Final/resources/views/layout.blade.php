...
<head>
    ...
    <title>Home - Gaming Corner</title>
    <!-- Css -->
...
<body>
    <div id="wrapper">
        ...
        <div class="sidebar">
            ...
            <p class="brand-title"><a href="">Gaming Corner</a></p>
            ...
            <footer class="sidebar-footer">
                <div>
                    <a href="https://www.facebook.com/ikramhidayat.1006/" target="_blank"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.instagram.com/ramstuy/" target="_blank"><i class="fab fa-instagram"></i></a>
                    <a href="https://twitter.com/Ramstuy" target="_blank"><i class="fab fa-twitter"></i></a>
                </div>

                <small>&copy Ramstuy 2022</small>
            </footer>
        </div>
        <!-- Menu Button -->
